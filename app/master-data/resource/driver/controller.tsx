...
function useTable(): TableConfig {
  ...
  return {
    columns,
    url: `${API_BASE_URL}/api/master-data/driver/master-driver/`,
    method: 'POST' as const,
    initSort: [{ column: 'driver_id', dir: 'asc' as const }],
  };
}
  ...
  return (
    <div className="h-full flex flex-col bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden">
      <div className="px-4 py-2 border-b-0 bg-muted/50">
        <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-200 m-0">Drivers</h2>
      </div>
